...
class MyClsDatasetMSF(MyClsDataset):

    def __init__(self, img_name_list_path, scales, inter_transform=None, unit=1):
        super().__init__(img_name_list_path, transform=None)
        self.scales = scales
        self.unit = unit
...
class MyAffDataset(MyImageDataset):

    def __init__(self, img_name_list_path, label_la_dir, label_ha_dir, cropsize, radius=5,
...
class VOC12AffGtDataset(MyImageDataset):
